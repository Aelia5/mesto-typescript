...
const popupName = popupProfile.querySelector('.popup__item_content_name')! as HTMLInputElement;
const popupAbout = popupProfile.querySelector('.popup__item_content_about')! as HTMLInputElement;
